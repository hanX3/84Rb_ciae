...
// Mon Aug  8 16:52:39 2022 by ROOT version 6.24/02
// from TTree tree/PKU XIA Pixie-16 Data
// found on file: ../../data/data_R0150.root
//////////////////////////////////////////////////////////

#ifndef ana_ts_window_h
#define ana_ts_window_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ana_ts_window(TTree *tree=0);
   virtual ~ana_ts_window();
...
#ifdef ana_ts_window_cxx
ana_ts_window::ana_ts_window(TTree *tree) : fChain(0) 
{
...
ana_ts_window::~ana_ts_window()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ana_ts_window::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ana_ts_window::LoadTree(Long64_t entry)
{
...
void ana_ts_window::Init(TTree *tree)
{
...
void ana_ts_window::Show(Long64_t entry)
{
...
Int_t ana_ts_window::Cut(Long64_t entry)
{
